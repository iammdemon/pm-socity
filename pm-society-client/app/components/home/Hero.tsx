...
export default function Hero() {
  ...
  // Optimized mute toggle with error handling
    ...
    <section className="relative w-full md:h-screen min-h-[400px] py-6 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          style={{
            // Prevent iOS video controls from showing
        ...
        {/* Overlay with conditional opacity based on video load */}
        <div 
      ...
      {/* Sound Toggle Button - Only show if video is loaded and not iOS (iOS has restrictions) */}
      {isVideoLoaded && !isIOS && (
        <button
          onClick={toggleMute}
