...
const teamMembers = [
  {
    ...
    role: "Founder & CEO",
    bio: "Blending vision and strategy, Olivia leads The PM Society in empowering project professionals. She drives growth and ensures every program reflects the Society's core values.",
...

  {
    ...
    role: "VP, People & Leadership Development",
    bio: "Driving executive coaching and leadership programs, Toni empowers professionals to lead with authenticity. She builds people-focused strategies that strengthen confidence and career growth.",
    image: "/image/tony.webp",
    achievements: "Coaching & Leadership Development",
  },
];
...
const certifications = [
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dggotjc19/image/upload/v1752432219/Picture1_vapnqk.png",
  },
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <section className="py-20 relative bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-12">
                <div className="group">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-gray-900 dark:bg-white rounded-xl flex items-center justify-center mr-4">
                      <BiBookOpen className="h-6 w-6 text-white dark:text-gray-900" />
                    </div>
                    <h2
                      className={`${bonVivant.className} text-3xl md:text-5xl text-black dark:text-white`}
                    >
                      Our Mission
                    </h2>
                  </div>
                  <div className="bg-white dark:bg-gray-700 rounded-2xl p-8 border border-gray-200 dark:border-gray-600 shadow-xl hover:shadow-2xl transition-all duration-500 group-hover:translate-y-1">
                ...
                <div className="group">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-gray-900 dark:bg-white rounded-xl flex items-center justify-center mr-4">
                      <BiTrendingUp className="h-6 w-6 text-white dark:text-gray-900" />
                    </div>
                    <h2
                      className={`${bonVivant.className} text-3xl md:text-5xl text-black dark:text-white`}
                    >
                ...
                >
                  ...
                  {!hasStarted && (
                    ...
                    >
                      ...
                      {/* Play button */}
                      <motion.div
                        className="flex items-center justify-center w-20 h-20 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-2xl hover:bg-white dark:hover:bg-gray-800 transition-colors z-30"
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.95 }}
                        animate={{ scale: [1, 1.05, 1] }}
                        transition={{ duration: 2, repeat: Infinity }}
                      >
                        <FaPlay className="w-8 h-8 text-gray-900 dark:text-white ml-1" />
                      </motion.div>
                    </motion.div>
                  )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {CoreValues.map((value, index) => (
                <div key={index} className="group relative">
                  <div className="absolute inset-0 bg-gray-900/20 dark:bg-white/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-all duration-500"></div>
                  <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 h-full">
                    ...
                    <div className="mt-6 w-full h-1 bg-gray-900 dark:bg-white rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {teamMembers.map((member, index) => (
                <div key={index} className="group relative">
                  ...
                  <div className="relative flex flex-col bg-white dark:bg-gray-800 rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                    <div className="relative h-80 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-3 py-1 text-xs font-semibold text-gray-700 dark:text-gray-300">
                        {member.achievements}
                      </div>
                    </div>
                      ...
                      {member.credentials && (
                        <div className="flex flex-wrap gap-2 my-2">
                          {member.credentials.map((cred, i) => (
                            <span
                              key={i}
                              className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-xs p-2 font-medium rounded-full"
                            >
                              {cred}
                            </span>
                          ))}
        ...
        <section className="py-12 relative bg-white dark:bg-gray-900 transition-colors duration-300">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <div className="inline-flex items-center px-3 py-1.5 bg-gray-200 dark:bg-gray-800 rounded-full mb-4 border border-gray-300 dark:border-gray-700">
                <BiAward className="h-4 w-4 text-black dark:text-white mr-2" />
                <span className="text-sm font-medium text-black dark:text-white">
                  Industry Recognized Certifications
                </span>
              </div>
              <h2
                className={`${bonVivant.className} text-2xl md:text-4xl text-black dark:text-white`}
              >
                Our Certifications
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {certifications.map((cert, index) => (
                <div key={index} className="group relative">
                  ...
                  {/* Main Card */}
                  <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-5 border border-gray-200 dark:border-gray-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 min-h-[220px] flex flex-col items-center justify-center text-center group-hover:bg-white dark:group-hover:bg-gray-800">
                    {/* Icon */}
                    <div
                    ...
                    <h3 className="text-base font-bold text-gray-900 dark:text-white leading-tight mb-2 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300">
                      {cert.name}
                    </h3>
                    ...
                    <div className="absolute top-3 right-3 w-1.5 h-1.5 bg-gray-300 dark:bg-gray-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="absolute top-5 right-5 w-1 h-1 bg-gray-400 dark:bg-gray-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  </div>

                  {/* Floating dots */}
                  <div className="absolute -top-1.5 -left-1.5 w-5 h-5 bg-gray-900 dark:bg-white rounded-full opacity-0 group-hover:opacity-60 transition-all duration-700 animate-bounce"></div>
                  <div className="absolute -bottom-1.5 -right-1.5 w-3 h-3 bg-gray-900 dark:bg-white rounded-full opacity-0 group-hover:opacity-60 transition-all duration-700 animate-bounce delay-300"></div>
                </div>
              ))}
            </div>

            <div className="mt-12 text-center">
              <div className="inline-flex items-center px-5 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
