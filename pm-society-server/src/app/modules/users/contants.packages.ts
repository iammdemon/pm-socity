export const packages = {
  IGNITE: {
    ...
    price: 99900, // $999
    description:
      "IGNITE Package with PM 101, 2 exec coaching, 2m material+portal",
  },
  ELEVATE: {
    type: "one-time",
    price: 350000, // $3,500
  ...
  "THE SOCIETY": {
    type: "subscription",
    priceIdMonthly: 4900, // $49
    priceIdAnnual: 49900, // $499
    description: "THE SOCIETY membership with growth matching, library & events",
  },
  "THE SOCIETY+": {
    type: "subscription",
    priceIdMonthly: 8900, // $89
    priceIdAnnual: 89900, // $899
    description:
      "THE SOCIETY+ membership with monthly coaching/mentorship + community",
  },
  "BUILD YOUR OWN PATH": {
    type: "one-time",
    price: 40000, // 3 sessions for $400
    description:
      "Customized coaching with choice of executive, mentorship, communication, or Agile focus",
  },
